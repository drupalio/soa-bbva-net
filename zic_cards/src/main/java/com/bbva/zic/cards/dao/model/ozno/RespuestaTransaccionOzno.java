...
/**
 * Bean de respuesta para la transacci&oacute;n <code>OZNO</code>
 * 
...
@Multiformato(formatos = {FormatoOZECNOS0.class })
@RooJavaBean
@RooToString
@RooSerializable
public class RespuestaTransaccionOzno implements MensajeMultiparte {
