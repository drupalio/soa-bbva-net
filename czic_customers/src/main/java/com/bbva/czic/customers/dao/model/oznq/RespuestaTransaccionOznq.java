...
/**
 * Bean de respuesta para la transacci&oacute;n <code>OZNQ</code>
 * 
...
@Multiformato(formatos = {FormatoOZECNQS0.class })
@RooJavaBean
@RooToString
@RooSerializable
public class RespuestaTransaccionOznq implements MensajeMultiparte {
