...
/**
 * Test de la transacci&oacute;n <code>OZNP</code>
 * 
...
public class TestTransaccionOznp {
	
	private static final Log LOG = I18nLogFactory.getLog(TestTransaccionOznp.class);
		
	@Autowired
	private TransaccionOznp transaccion;
	...
	public void test() throws ExcepcionTransaccion {
		...
		try {
			...
			RespuestaTransaccionOznp respuesta = transaccion.invocar(peticion);
