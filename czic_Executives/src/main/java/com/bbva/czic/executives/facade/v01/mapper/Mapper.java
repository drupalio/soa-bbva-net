...
public class Mapper {
 ...
 public static EnumThirdPartyType enumThirdPartyTypeMap(DTOIntEnumThirdPartyType dtoIntEnumThirdPartyType) { 
 		EnumThirdPartyType enumThirdPartyType = new EnumThirdPartyType(); 
 		BeanUtils.copyProperties(dtoIntEnumThirdPartyType, enumThirdPartyType); 
 		return enumThirdPartyType; 
 } 

		
 public static DTOIntEnumThirdPartyType dtoIntEnumThirdPartyTypeMap(EnumThirdPartyType enumThirdPartyType) { 
 		DTOIntEnumThirdPartyType dtoIntEnumThirdPartyType = new DTOIntEnumThirdPartyType(); 
 		BeanUtils.copyProperties(enumThirdPartyType, dtoIntEnumThirdPartyType); 
 		return dtoIntEnumThirdPartyType; 
 } 
