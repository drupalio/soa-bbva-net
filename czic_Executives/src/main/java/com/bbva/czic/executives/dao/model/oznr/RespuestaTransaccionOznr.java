...
/**
 * Bean de respuesta para la transacci&oacute;n <code>OZNR</code>
 * 
...
@Multiformato(formatos = {FormatoOZECNRS0.class })
@RooJavaBean
@RooToString
@RooSerializable
public class RespuestaTransaccionOznr implements MensajeMultiparte {
