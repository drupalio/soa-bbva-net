...
/**
 * Bean de respuesta para la transacci&oacute;n <code>OZNJ</code>
 * 
...
@Multiformato(formatos = {FormatoOZNCSNJ0.class })
@RooJavaBean
@RooToString
@RooSerializable
public class RespuestaTransaccionOznj implements MensajeMultiparte {
