...
/**
 * Bean de respuesta para la transacci&oacute;n <code>OZNI</code>
 * 
...
@Multiformato(formatos = {FormatoOZNCSNI0.class })
@RooJavaBean
@RooToString
@RooSerializable
public class RespuestaTransaccionOzni implements MensajeMultiparte {
