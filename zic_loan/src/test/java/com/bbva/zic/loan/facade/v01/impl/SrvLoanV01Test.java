...
public class SrvLoanV01Test extends SpringContextBbvaTest {
    ...
    public void callGetRotaryQuotaWithAllParametersOkTest(){
        ...
        Assert.assertEquals(loan.getStatus(),dtoIntLoan.getStatus());
    ...
    public void callListRotaryQuotaMovementsWithParametersAllOkTest(){
        ...
        final List<Movement> m = srvLoanV01.listRotaryQuotaMovements("00816641", 5, "234", "7643", filter);
    ...
    public void callGetRotaryQuotaMovementWithParametersAllOkTest(){
        ...
        final RotaryQuotaMove result = srvLoanV01.getRotaryQuotaMovement("1234", "4567", "(movementNumber=23456)");
    ...
    public void mapperDTOIntMovementToMovementListException() {
        ...
        srvLoanV01.listRotaryQuotaMovements("00816641", 5, "34567", "456", filter);
    }
    ...
    public void filterWrongException() {
        ...
        srvLoanV01.listRotaryQuotaMovements("00816641", 5, "4", "876", filter);
    }
