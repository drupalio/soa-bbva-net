...
import com.bbva.zic.routine.mapper.impl.Comparators;
import com.bbva.zic.routine.mapper.impl.util.ClassUtil;
import com.bbva.zic.routine.mapper.metadata.ConverterKey;
import com.bbva.zic.routine.mapper.metadata.Type;
import com.bbva.zic.routine.mapper.metadata.TypeFactory;
import com.bbva.zic.routine.mapper.util.Cache;
import com.bbva.zic.routine.mapper.util.CacheLRULinkedHashMap;
import com.bbva.zic.routine.mapper.util.SortedSet;
...
public class DefaultConverterFactory implements ConverterFactory {
     ...
     */
    @Deprecated
    public <S, D> void registerConverter(com.bbva.zic.routine.mapper.converter.Converter<S, D> converter) {
        
        registerConverter(new com.bbva.zic.routine.mapper.converter.Converter.LegacyConverter<S, D>(converter));
    }
     ...
     */
    @Deprecated
    public <S, D> void registerConverter(String converterId, com.bbva.zic.routine.mapper.converter.Converter<S, D> converter) {
        
        registerConverter(converterId, new com.bbva.zic.routine.mapper.converter.Converter.LegacyConverter<S, D>(converter));
    }
}
