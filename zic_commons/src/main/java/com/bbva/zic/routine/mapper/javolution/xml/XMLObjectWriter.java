...
public class XMLObjectWriter implements Reusable {
     ...
     * @see    com.bbva.zic.routine.mapper.javolution.xml.stream.XMLStreamWriterImpl#setOutput(OutputStream)
     */
     ...
     * @return <code>this</code>
     * @see    com.bbva.zic.routine.mapper.javolution.xml.stream.XMLStreamWriterImpl#setOutput(OutputStream, String)
     */
     ...
     * @return <code>this</code>
     * @see    com.bbva.zic.routine.mapper.javolution.xml.stream.XMLStreamWriterImpl#setOutput(Writer)
     */
