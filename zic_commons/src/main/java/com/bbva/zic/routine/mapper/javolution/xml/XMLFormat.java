 ...
 */
package com.bbva.zic.routine.mapper.javolution.xml;

import java.lang.CharSequence;

import com.bbva.zic.routine.mapper.javolution.lang.Reflection;
import com.bbva.zic.routine.mapper.javolution.text.CharArray;
import com.bbva.zic.routine.mapper.javolution.text.Text;
import com.bbva.zic.routine.mapper.javolution.text.TextBuilder;
import com.bbva.zic.routine.mapper.javolution.text.TextFormat;
import com.bbva.zic.routine.mapper.javolution.xml.sax.Attributes;
import com.bbva.zic.routine.mapper.javolution.xml.stream.XMLStreamException;
import com.bbva.zic.routine.mapper.javolution.xml.stream.XMLStreamReader;
import com.bbva.zic.routine.mapper.javolution.xml.stream.XMLStreamReaderImpl;
import com.bbva.zic.routine.mapper.javolution.xml.stream.XMLStreamWriter;
import com.bbva.zic.routine.mapper.javolution.xml.stream.XMLStreamWriterImpl;
import com.bbva.zic.routine.mapper.javolution.text.CharArray;
import com.bbva.zic.routine.mapper.javolution.text.TextFormat;
import com.bbva.zic.routine.mapper.javolution.xml.sax.Attributes;
import com.bbva.zic.routine.mapper.javolution.xml.stream.XMLStreamWriter;
 ...
 *    {@link com.bbva.zic.routine.mapper.javolution.text.TextFormat#getInstance known} can be represented as
 *    a XML attribute.</p>
 * 
...
public abstract class XMLFormat <T>  {
     ...
     *    (see {@link com.bbva.zic.routine.mapper.javolution.text.TextFormat#getInstance}).</p>
     *
    ...
    public static final class InputElement {
         ...
         * {@link com.bbva.zic.routine.mapper.javolution.xml.stream.XMLStreamReader#getElementText
         ...
         * {@link com.bbva.zic.routine.mapper.javolution.text.TextFormat#getInstance TextFormat} is
    ...
    public static final class OutputElement {
         ...
         * com.bbva.zic.routine.mapper.javolution.xml.stream.XMLStreamWriter#writeCharacters(CharSequence)
         ...
         * {@link com.bbva.zic.routine.mapper.javolution.text.TextFormat#getInstance TextFormat}.
         * 
         * @param  name the name of the attribute.
         * @param  value the <code>Boolean</code> value for the specified attribute
