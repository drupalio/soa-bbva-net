...
package com.bbva.zic.routine.mapper.metadata;
...
import com.bbva.zic.routine.mapper.MapperBase;
import com.bbva.zic.routine.mapper.MappingHint;
...
import com.bbva.zic.routine.mapper.impl.UtilityResolver;
import com.bbva.zic.routine.mapper.property.PropertyResolver;
...
public class ClassMapBuilder<A, B> implements MappedTypePair<A, B> {
     ...
     * each time; instead, {@link com.bbva.zic.routine.mapper.MapperFactory#classMap(Type, Type)} should
     ...
     * @param bType
     * @return
     * @deprecated use {@link com.bbva.zic.routine.mapper.MapperFactory#classMap(Class, Class)} instead
     */
     ...
     * @param bType
     * @return
     * @deprecated use {@link com.bbva.zic.routine.mapper.MapperFactory#classMap(Type, Type)} instead
     */
     ...
     * @param bType
     * @return
     * @deprecated use {@link com.bbva.zic.routine.mapper.MapperFactory#classMap(Class, Type)} instead
     */
     ...
     * @param bType
     * @return
     * @deprecated use {@link com.bbva.zic.routine.mapper.MapperFactory#classMap(Type, Class)} instead
     */
