...
import com.bbva.czic.dto.canonicaldto.ContactInformation;
import com.bbva.czic.dto.canonicaldto.Email;
import com.bbva.czic.dto.canonicaldto.Movement;
import com.bbva.czic.dto.canonicaldto.Operation;
import com.bbva.czic.dto.canonicaldto.PhoneNumber;
...
public class Mapper {
	...
	// public static EnumFinancialStatusType enumFinancialStatusTypeMap(
	// DTOIntEnumFinancialStatusType dtoIntEnumFinancialStatusType) {
	// return EnumFinancialStatusType.valueOf(dtoIntEnumFinancialStatusType.name());
	// }

	// public static DTOIntEnumFinancialStatusType dtoIntEnumFinancialStatusTypeMap(
	// EnumFinancialStatusType enumFinancialStatusType) {
