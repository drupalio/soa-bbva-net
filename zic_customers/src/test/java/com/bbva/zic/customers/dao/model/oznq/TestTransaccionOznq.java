...
/**
 * Test de la transacci&oacute;n <code>OZNQ</code>
 * 
...
public class TestTransaccionOznq {
	
	private static final Log LOG = I18nLogFactory.getLog(TestTransaccionOznq.class);
		
	@Autowired
	private TransaccionOznq transaccion;
	...
	public void test() throws ExcepcionTransaccion {
		...
		try {
			...
			RespuestaTransaccionOznq respuesta = transaccion.invocar(peticion);
