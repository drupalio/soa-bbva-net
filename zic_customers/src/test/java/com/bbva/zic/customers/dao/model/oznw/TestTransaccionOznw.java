...
/**
 * Test de la transacci&oacute;n <code>OZNW</code>
 * 
...
public class TestTransaccionOznw {
	
	private static final Log LOG = I18nLogFactory.getLog(TestTransaccionOznw.class);
		
	@Autowired
	private TransaccionOznw transaccion;
	
	@Test
	public void test() throws ExcepcionTransaccion {
		
		PeticionTransaccionOznw peticion = new PeticionTransaccionOznw();		
		...
		try {
			...
			RespuestaTransaccionOznw respuesta = transaccion.invocar(peticion);
