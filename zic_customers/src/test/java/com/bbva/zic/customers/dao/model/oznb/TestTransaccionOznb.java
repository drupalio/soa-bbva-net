...
/**
 * Test de la transacci&oacute;n <code>OZNB</code>
 * 
...
public class TestTransaccionOznb {
	
	private static final Log LOG = I18nLogFactory.getLog(TestTransaccionOznb.class);
		
	@Autowired
	private TransaccionOznb transaccion;
	...
	public void test() throws ExcepcionTransaccion {
		...
		try {
			...
			RespuestaTransaccionOznb respuesta = transaccion.invocar(peticion);
