...
/**
 * Bean de respuesta para la transacci&oacute;n <code>OZNP</code>
 * 
...
@Multiformato(formatos = {FormatoOZECNPS0.class })
@RooJavaBean
@RooToString
@RooSerializable
public class RespuestaTransaccionOznp implements MensajeMultiparte {
