...
/**
 * Bean de respuesta para la transacci&oacute;n <code>OZNB</code>
 * 
...
@Multiformato(formatos = {FormatoOZNCSNB0.class })
@RooJavaBean
@RooToString
@RooSerializable
public class RespuestaTransaccionOznb implements MensajeMultiparte {
