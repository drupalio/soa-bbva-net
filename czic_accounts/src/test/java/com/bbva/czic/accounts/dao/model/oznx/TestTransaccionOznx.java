...
public class TestTransaccionOznx {
	...
	public void test() throws ExcepcionTransaccion {
		...
		PeticionTransaccionOznx peticion = new PeticionTransaccionOznx();		
		...
		try {
			...
			RespuestaTransaccionOznx respuesta = transaccion.invocar(peticion);
