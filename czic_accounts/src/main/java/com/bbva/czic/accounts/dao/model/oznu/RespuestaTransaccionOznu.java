...
/**
 * Bean de respuesta para la transacci&oacute;n <code>OZNU</code>
 * 
...
@Multiformato(formatos = {FormatoOZECNUS0.class })
@RooJavaBean
@RooToString
@RooSerializable
public class RespuestaTransaccionOznu implements MensajeMultiparte {
