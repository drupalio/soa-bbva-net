...
/**
 * Bean de respuesta para la transacci&oacute;n <code>OZNY</code>
 * 
...
@Multiformato(formatos = {FormatoOZECNYS0.class })
@RooJavaBean
@RooToString
@RooSerializable
public class RespuestaTransaccionOzny implements MensajeMultiparte {
