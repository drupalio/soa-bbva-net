...
/**
 * Bean de respuesta para la transacci&oacute;n <code>OZNV</code>
 * 
...
@Multiformato(formatos = {FormatoOZECNVS0.class })
@RooJavaBean
@RooToString
@RooSerializable
public class RespuestaTransaccionOznv implements MensajeMultiparte {
