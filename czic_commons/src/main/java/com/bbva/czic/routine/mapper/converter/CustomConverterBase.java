 ...
 * @deprecated use {@link com.bbva.czic.routine.mapper.CustomConverter} instead
 */
@Deprecated
public abstract class CustomConverterBase<S, D> implements com.bbva.czic.routine.mapper.converter.Converter<S, D> {
