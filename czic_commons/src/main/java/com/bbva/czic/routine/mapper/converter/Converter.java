...
public interface Converter<S, D> extends MappedTypePair<S, D> {
     ...
     * @param <D>
     */
    public static class LegacyConverter<S, D> implements com.bbva.czic.routine.mapper.Converter<S, D> {
        
        private com.bbva.czic.routine.mapper.converter.Converter<S, D> delegate;
        
        public LegacyConverter(com.bbva.czic.routine.mapper.converter.Converter<S, D> delegate) {
