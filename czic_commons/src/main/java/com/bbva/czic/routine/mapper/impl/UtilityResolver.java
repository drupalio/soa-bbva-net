...
import com.bbva.czic.routine.mapper.OrikaSystemProperties;
import com.bbva.czic.routine.mapper.constructor.ConstructorResolverStrategy;
import com.bbva.czic.routine.mapper.constructor.SimpleConstructorResolverStrategy;
import com.bbva.czic.routine.mapper.converter.ConverterFactory;
import com.bbva.czic.routine.mapper.converter.DefaultConverterFactory;
import com.bbva.czic.routine.mapper.impl.generator.CompilerStrategy;
import com.bbva.czic.routine.mapper.impl.generator.JavassistCompilerStrategy;
import com.bbva.czic.routine.mapper.metadata.ClassMapBuilderFactory;
import com.bbva.czic.routine.mapper.property.IntrospectorPropertyResolver;
...
public abstract class UtilityResolver {
    ...
    public static ClassMapBuilderFactory getDefaultClassMapBuilderFactory() {
        return resolveUtility(OrikaSystemProperties.CLASSMAP_BUILDER_FACTORY, com.bbva.czic.routine.mapper.metadata.ClassMapBuilder.Factory.class);
    }
