 ...
 */
package com.bbva.czic.routine.mapper.javolution.testing;

import java.lang.CharSequence;

import com.bbva.czic.routine.mapper.javolution.context.Context;
...
import com.bbva.czic.routine.mapper.javolution.lang.Configurable;
import com.bbva.czic.routine.mapper.javolution.lang.MathLib;
import com.bbva.czic.routine.mapper.javolution.text.Text;
import com.bbva.czic.routine.mapper.javolution.util.FastTable;
...
public abstract class TestContext extends LogContext {
    ...
    protected boolean doAssert(boolean value, CharSequence message) {
        ...
        com.bbva.czic.routine.mapper.javolution.text.TextBuilder tmp = com.bbva.czic.routine.mapper.javolution.text.TextBuilder.newInstance();
        try {
            tmp.append(message);
            ...
            com.bbva.czic.routine.mapper.javolution.text.TextBuilder.recycle(tmp);
        }
        /**/
        return false;
    }
