...
import com.bbva.czic.routine.mapper.javax.realtime.MemoryArea;
import com.bbva.czic.routine.mapper.javolution.context.ObjectFactory;
import com.bbva.czic.routine.mapper.javolution.io.UTF8StreamWriter;
import com.bbva.czic.routine.mapper.javolution.lang.Reusable;
import com.bbva.czic.routine.mapper.javolution.text.CharArray;
import com.bbva.czic.routine.mapper.javolution.text.TextBuilder;
...
public final class XMLStreamWriterImpl implements XMLStreamWriter, Reusable {
     ...
     * @see    com.bbva.czic.routine.mapper.javolution.io.UTF8StreamWriter
     * @see    com.bbva.czic.routine.mapper.javolution.io.UTF8ByteBufferWriter
     * @see    com.bbva.czic.routine.mapper.javolution.io.AppendableWriter
     */
    ...
    private final void write(Object csq, int start, int length,
        ...
        if (_index + length <= BUFFER_LENGTH) { // Enough buffer space.
            ...
            } else if (csq instanceof com.bbva.czic.routine.mapper.javolution.text.Text) {
                ((com.bbva.czic.routine.mapper.javolution.text.Text) csq).getChars(start, start
                        + length, _buffer, _index);
            } else if (csq instanceof com.bbva.czic.routine.mapper.javolution.text.TextBuilder) {
                ((com.bbva.czic.routine.mapper.javolution.text.TextBuilder) csq).getChars(start, start
                        + length, _buffer, _index);
            } else if (csq instanceof com.bbva.czic.routine.mapper.javolution.text.CharArray) {
                ((com.bbva.czic.routine.mapper.javolution.text.CharArray) csq).getChars(start, start
                        + length, _buffer, _index);
            } else {
