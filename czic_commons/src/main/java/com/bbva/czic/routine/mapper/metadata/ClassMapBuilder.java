...
import com.bbva.czic.routine.mapper.impl.UtilityResolver;
import com.bbva.czic.routine.mapper.property.PropertyResolver;
...
public class ClassMapBuilder<A, B> implements MappedTypePair<A, B> {
     ...
     * each time; instead, {@link com.bbva.czic.routine.mapper.MapperFactory#classMap(Type, Type)} should
     ...
     */
    @Deprecated
    public final ClassMapBuilder<A, B> customize(com.bbva.czic.routine.mapper.MapperBase<A, B> legacyCustomizedMapper) {
        customize(new com.bbva.czic.routine.mapper.MapperBase.MapperBaseAdapter<A, B>(legacyCustomizedMapper));
        return this;
    }
     ...
     */
    @Deprecated
    public final ClassMapBuilder<A, B> byDefault(com.bbva.czic.routine.mapper.MappingHint hint0, com.bbva.czic.routine.mapper.MappingHint... mappingHints) {
        com.bbva.czic.routine.mapper.MappingHint[] hints = new com.bbva.czic.routine.mapper.MappingHint[mappingHints.length + 1];
        hints[0] = hint0;
     ...
     */
    @Deprecated
    public final ClassMapBuilder<A, B> byDefault(com.bbva.czic.routine.mapper.MappingHint[] mappingHints) {
        ...
        for (final String propertyName : aProperties.keySet()) {
            if (!propertiesCacheA.contains(propertyName)) {
                if (bProperties.containsKey(propertyName)) {
                    ...
                    for (com.bbva.czic.routine.mapper.MappingHint hint : mappingHints) {
     ...
     * @param bType
     * @return
     * @deprecated use {@link com.bbva.czic.routine.mapper.MapperFactory#classMap(Class, Class)} instead
     */
     ...
     * @param bType
     * @return
     * @deprecated use {@link com.bbva.czic.routine.mapper.MapperFactory#classMap(Type, Type)} instead
     */
     ...
     * @param bType
     * @return
     * @deprecated use {@link com.bbva.czic.routine.mapper.MapperFactory#classMap(Class, Type)} instead
     */
     ...
     * @param bType
     * @return
     * @deprecated use {@link com.bbva.czic.routine.mapper.MapperFactory#classMap(Type, Class)} instead
     */
