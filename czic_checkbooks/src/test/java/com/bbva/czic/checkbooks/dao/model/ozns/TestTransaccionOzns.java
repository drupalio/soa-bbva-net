...
/**
 * Test de la transacci&oacute;n <code>OZNS</code>
 * 
...
public class TestTransaccionOzns {
	
	private static final Log LOG = I18nLogFactory.getLog(TestTransaccionOzns.class);
		
	@Autowired
	private TransaccionOzns transaccion;
	...
	public void test() throws ExcepcionTransaccion {
		...
		try {
			...
			RespuestaTransaccionOzns respuesta = transaccion.invocar(peticion);
