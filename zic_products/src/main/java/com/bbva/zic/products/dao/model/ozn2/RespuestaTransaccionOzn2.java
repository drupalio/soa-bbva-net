...
/**
 * Bean de respuesta para la transacci&oacute;n <code>OZN2</code>
 * 
...
@Multiformato(formatos = {FormatoOZECN2S0.class })
@RooJavaBean
@RooToString
@RooSerializable
public class RespuestaTransaccionOzn2 implements MensajeMultiparte {
