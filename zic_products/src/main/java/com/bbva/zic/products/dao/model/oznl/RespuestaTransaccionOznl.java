...
/**
 * Bean de respuesta para la transacci&oacute;n <code>OZNL</code>
 * 
...
@Multiformato(formatos = {FormatoOZECNLS0.class })
@RooJavaBean
@RooToString
@RooSerializable
public class RespuestaTransaccionOznl implements MensajeMultiparte {
