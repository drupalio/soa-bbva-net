package com.bbva.zic.accounts.facade.v01.impl;
...
import com.bbva.zic.accounts.facade.v01.ISrvAccountsV01;
...
public class SrvAccountsV01 implements ISrvAccountsV01,
	...
	@ApiResponses(value = {
			@ApiResponse(code = -1, message = "aliasGCE1"),
			@ApiResponse(code = -1, message = "aliasGCE2"),
			@ApiResponse(code = 200, message = "Found Successfully", response = Response.class),
