...
/**
 * Bean de respuesta para la transacci&oacute;n <code>OZNS</code>
 * 
...
@Multiformato(formatos = {FormatoOZECNSS0.class })
@RooJavaBean
@RooToString
@RooSerializable
public class RespuestaTransaccionOzns implements MensajeMultiparte {
