...
import com.bbva.zic.accounts.business.dto.DTOIntResponseListCheck;
import com.bbva.zic.routine.commons.rm.utils.CurrencyEnum;
import com.bbva.zic.routine.commons.rm.utils.tx.IFormatNotApply;
import com.bbva.zic.routine.commons.rm.utils.tx.IPaginatedTransactionMapper;
...
public class ListCheckMapper
		implements
		IPaginatedTransactionMapper<DTOIntCheck, FormatoOZECNXE0, DTOIntResponseListCheck, IFormatNotApply, DTOIntCheck, FormatoOZECNXS0, IFormatNotApply> {
